...
export default function Cta() {
  return (
    <section className='px-4 md:px-8 bg-custom-green text-white py-12'>
      <div className="max-w-screen-web mx-auto">
        <h2 className='text-xl md:text-3xl font-bold text-center '>Are you ready for collaboration?</h2>
